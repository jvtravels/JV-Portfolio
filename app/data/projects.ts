...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: "specter",
    shortTitle: "Dono",
    title: "Dono — Creating a brand people can recognize",
    tags: ["Brand Identity", "Art Direction"],
    description: "The goal was simple: make Dono feel like itself. I worked across identity, art direction, digital, and the brand deck to build a system that could stay consistent without getting boring.",
  ...
  },
  {
    ...
    description: "A digital home for hand-carved Balinese sculpture, built to sell story and craftsmanship rather than compete on a product grid.",
    whatIs: "KAYU Bali sells hand-carved Balinese wood sculpture and objects online. The site frames every piece as a story-carrying artifact — full-bleed jungle photography, large-format product shots, and editorial type slow the browsing experience down instead of racing to a cart.",
    timeline: "2026",
    problem: "Handmade, culturally rooted objects get flattened into generic product-grid e-commerce, competing on price against mass-produced décor instead of on story, heritage, and craft.",
    tldrDecisions: [
      "Opened on a cinematic Ubud jungle hero instead of a product grid",
      "Framed the brand around four values — authenticity, story, heritage, craft — instead of feature bullets",
      "Let each carving breathe with large-format, colour-graded photography instead of thumbnail grids",
    ],
    solution: "The homepage opens on a full-bleed hero of the Ubud rice terraces before introducing 'The essence of KAYU BALI' with hand-carved pieces shot large against moody, colour-graded backdrops. A 'Who we are for' section reframes the buying decision around values — authenticity over imitation, story over status, heritage over hype, craft over convenience — instead of specs.",
    results: "Live at kayu-bali.com, positioning KAYU Bali as a considered art destination rather than a home-décor storefront.",
    metrics: [
      { value: "Bali", label: "Sourced & handcrafted" },
      { value: "4", label: "Core brand pillars" },
      { value: "2026", label: "Launched" },
    ],
    learningsList: [
      "Slowing the browsing experience down with full-bleed imagery and editorial pacing can support premium positioning for handmade goods better than a dense product grid.",
    ],
    ...
    images: [
      "/Work/Kayu/hero.jpg",
      "/Work/Kayu/mask.jpg",
      "/Work/Kayu/couple.jpg",
      "/Work/Kayu/garuda.jpg",
      "/Work/Kayu/arch-authenticity.jpg",
      "/Work/Kayu/arch-story.jpg",
      "/Work/Kayu/arch-heritage.jpg",
    ],
    userGroups: [
      { num: "01", title: "Collectors & Design Buyers", bullets: ["Furnishing a home with pieces that carry a story, not just a look", "Wary of mass-produced décor sold as \"handmade\"", "Judge authenticity by provenance, texture, and detail in photography"] },
      { num: "02", title: "Gift & Occasion Shoppers", bullets: ["Looking for a meaningful, one-of-a-kind gift", "Need the story behind a piece to feel real before they buy sight unseen", "Convert when craft and heritage come through in the imagery"] },
    ],
    hmwQuestion: "How might we make handmade, story-rich sculpture feel more valuable than mass-produced décor when browsing online?",
    brandNote: "Warm, earthy, and unhurried — closer to a gallery guide than a storefront.",
  },
  {
    slug: "the-signal",
