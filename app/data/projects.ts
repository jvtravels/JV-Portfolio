...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: "2023",
    images: ["rDJ5VixMzo7xJq21ruy4Sxxc6hs"].map(FU).concat(["/Work/BoldAir/B2.png"], ["MhU890cqYObCfX1KRm47xlLIUmw","PW4fgszPdl29jJXd8UG6GxiIoOM","zxjF0itWDo6PeEOPaLx14AY0oX8","PpiIWmDONPNnVVD3egtvMkqkhCE","Z0DRdmk8aN84QUaAD7VJdQxRgFo"].map(FU)),
    userGroups: [
