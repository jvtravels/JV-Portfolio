...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    images: ["/Work/Kayu/K1.mp4", ...["Ki97QAhosBVwFWkAhgeLUQVGqkE"].map(FU), "/Work/Kayu/K3.jpg", "/Work/Kayu/K5.jpg", "/Work/Kayu/K6.jpg"],
    userGroups: [
  ...
  },
  {
    ...
    year: "2023",
    images: ["rDJ5VixMzo7xJq21ruy4Sxxc6hs","30xXx7xHYxSD5tVsKQFDvjTn5M"].map(FU).concat(["/Work/BoldAir/B2.png"], ["MhU890cqYObCfX1KRm47xlLIUmw","PW4fgszPdl29jJXd8UG6GxiIoOM","zxjF0itWDo6PeEOPaLx14AY0oX8","PpiIWmDONPNnVVD3egtvMkqkhCE","Z0DRdmk8aN84QUaAD7VJdQxRgFo"].map(FU)),
    userGroups: [
