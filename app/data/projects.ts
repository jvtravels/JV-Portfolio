...
export const PROJECTS: Project[] = [
  ...
  {
    slug: "tractorbeam",
    shortTitle: "Tractorbeam",
    title: "Tractorbeam — Web and identity for AI-focused private equity partner",
    tags: ["Web Design", "Development", "Branding"],
    description: "The goal was to build a website that establishes trust in the private equity market and clearly communicates Tractorbeam's end-to-end AI expertise.\n\nThe site and new visual identity was designed for investment professionals who expect clarity, credibility, and confidence from technical partners.",
    whatIs: "Tractorbeam is an AI-focused private equity partner that provides end-to-end technical expertise to portfolio companies — from infrastructure and architecture to product delivery and team building.",
    timeline: "8 weeks",
    problem: "Tractorbeam needed to establish credibility with investment professionals while communicating their end-to-end AI capabilities. Their existing presence didn't match the calibre of their work, and it was costing them in early-stage conversations.",
    tldrDecisions: [
      "Anchored the identity in expertise, not AI buzzwords — investors read between the lines",
      "Typography-led, no stock photography: every visual choice signals deliberateness",
      "Structured the site for two audiences: LPs evaluating credibility and founders evaluating fit",
      "Built a system that scales across print and digital without losing coherence",
    ],
    solution: "Stripped the site to what mattered: expertise, clarity, and confidence. Typography-led visual identity, no stock photography, structured to earn trust before the copy gets a chance.",
    results: "Positioned Tractorbeam as a credible technical partner for investment professionals. The identity now anchors all client-facing communications and pitch materials.",
    metrics: [
      { value: "8wk", label: "Brief to live" },
      { value: "2×", label: "Inbound inquiries" },
      { value: "↑", label: "Pitch alignment" },
    ],
    learningsList: [
      "Investment professionals evaluate design as a proxy for rigour. A polished identity signals the same precision they want in a technical partner.",
      "Brand is not decoration in professional services — it's the first proof of competency.",
      "Restraint is a statement. Saying less, with more confidence, is harder to execute and more effective when done.",
    ],
    industry: "Dev Team",
    ...
    userGroups: [
      ...
      { num: "03", title: "PE Deal Teams", bullets: ["Assessing whether Tractorbeam can slot into due diligence", "Need a presence that matches the rigour of the deal process", "Reference the website in partner meetings and pitch decks"] },
    ],
    hmwQuestion: "How might we build a web presence that signals technical depth and PE-grade credibility without relying on buzzwords or stock imagery?",
    brandNote: "An AI firm's brand has to demonstrate the same precision it sells. I led with typography over imagery — every visual decision made deliberately. No stock photography, no AI-generated hero sections. The identity was built to scale across print pitch decks and digital without breaking down.",
  },
  {
    slug: "axilon",
    shortTitle: "Axilon",
    title: "Axilon — Website and custom visuals for industrial acceleration software",
    tags: ["Web Design", "Development", "Illustrations", "Motion"],
    description: "Axilon needed a website that reflects its modern approach to industrial software.\n\nCustom technical illustrations helped explain complex deployment workflows with clarity, resulting in a contemporary, credible presence that matches the product's technical depth.",
    whatIs: "Axilon is an industrial acceleration software platform that helps manufacturers modernise their operations. Their product streamlines complex deployment workflows that traditionally require specialist engineers to configure.",
    timeline: "12 weeks",
    problem: "Complex deployment workflows that even technical users struggled to explain. The existing site looked generic and communicated nothing about what made Axilon different. Enterprise buyers were leaving without understanding the product.",
    tldrDecisions: [
      "Used custom technical illustration instead of UI screenshots to explain workflows",
      "Built motion sequences that walk users through the deployment logic step by step",
      "Designed for two reading modes: fast scan for executives, deep read for engineers",
      "Treated illustration as a brand asset, not a supplement — consistent across all pages",
    ],
    solution: "Custom technical illustrations explaining the workflows visually, paired with a site as modern as the product. Motion used to guide through the product's logic, not for decoration.",
    results: "A web presence that holds its own in enterprise sales conversations. Customers and partners now use the site as a reference point in their own pitches.",
    metrics: [
      { value: "12wk", label: "End to end" },
      { value: "40+", label: "Custom illustrations" },
      { value: "↑", label: "Sales asset quality" },
    ],
    learningsList: [
      "Custom illustration in B2B software is underused. One good diagram can do the work of five paragraphs of product copy.",
      "Motion earns its keep when it teaches. Animation that explains a workflow converts better than animation that decorates.",
      "Enterprise buyers don't need simplicity — they need clarity. There's a difference, and it shows in how you structure information.",
    ],
    ...
    userGroups: [
      ...
      { num: "03", title: "Enterprise Buyers", bullets: ["Signing off on multi-year infrastructure decisions", "Need the site to pass internal security and procurement review", "Reference the website in executive presentations"] },
    ],
    hmwQuestion: "How might we communicate complex industrial deployment workflows visually to an audience that doesn't have time to read?",
    brandNote: "Industrial software sites tend to look dated or generic. I used custom technical illustration as the primary brand asset — not decoration, but explanation. Every diagram earns its place by making a workflow legible that paragraphs of copy couldn't.",
  },
  {
    slug: "cypher",
    shortTitle: "Cypher",
